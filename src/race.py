...
def race(n_tests) -> tuple[int, int]:
    ...
    print(f"Game 1 (Stranding Player) Average Speed: {t1_avg}, out of {
          t1_runs} with {expected_runs - t1_runs} failures")
    print(f"Game 2 (Standard Player) Average Speed: {t2_avg}, out of {
          t2_runs} with {expected_runs - t2_runs} failures")
